...
def sellproduct():
    ...
    return render_template('sell_product.html', title='Sell a Product', form=form
                           , legend='Sell Product', searchbar=searchbar) #, image_file=image_file)
...
def product(prod_id):
    ...
    return render_template('product.html', product=product, title=product.productname,
                           img_location=img_location, searchbar=searchbar)
...
def manageproducts():
    ...
    return render_template('manage_products.html', title='Manage Your Products', form=form,
                           getProducts=getProducts, img_location=img_location, searchbar=searchbar)
...
def updateproduct(prod_id):
    ...
    return render_template('sell_product.html', product=product, title='Update Product'
                           , form=form, legend='Update Product', searchbar=searchbar) #, image_file=image_file)
...
def paymentconfirmed(prod_id):
    ...
    return render_template('payconfirmed.html', title='Checkout', form=form, legend='User Profile', product=product,
                           date=date, payment=payment, img_location=img_location, searchbar=searchbar)
